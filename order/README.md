...
The Microservice was developed for me, to demonstrate how to solve the [Payment Gateway Application](https://github.com/githubanotaai/new-test-backend-nodejs).
...
PUT /api/order/{id} - Updates a order
DELETE /api/order/{id} - Delete a order
```

**BODY**
```json
{
  "title": "Order para postar no tópico",
  "description": "",
  "ownerId": "4444444",
  "productId": "659d558b0304df732ddd4587",
  "price": 10000
}
```
